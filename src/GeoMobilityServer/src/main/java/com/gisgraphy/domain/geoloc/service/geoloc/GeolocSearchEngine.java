...
public class GeolocSearchEngine implements IGeolocSearchEngine {
	...
	public GeolocSearchEngine(IStatsUsageService statsUsageService) {
...
//				.getDao(GisFeature.class);
	...
	public void executeAndSerialize(GeolocQuery query, OutputStream outputStream)
		...
		extraParameter
				.put(
						GeolocResultsDtoSerializer.START_PAGINATION_INDEX_EXTRA_PARAMETER,
		...
		geolocResultsDtoSerializer.serialize(outputStream, query
				.getOutputFormat(), geolocResultsDto, query.isOutputIndented(),
				extraParameter);
	}
