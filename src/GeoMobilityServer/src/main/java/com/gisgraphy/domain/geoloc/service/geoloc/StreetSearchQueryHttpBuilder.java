...
public class StreetSearchQueryHttpBuilder extends GeolocQueryHttpBuilder {
	...
	@Override
	public StreetSearchQuery buildFromHttpRequest(HttpServletRequest req) throws GeolocSearchException, StreetSearchException {
		...
		String StreetSearchModeparameter = req
				.getParameter(StreetServlet.STREET_SEARCH_MODE_PARAMETER);
		streetSearchQuery.withStreetSearchMode(StreetSearchMode
				.getFromString(StreetSearchModeparameter));
		return streetSearchQuery;
