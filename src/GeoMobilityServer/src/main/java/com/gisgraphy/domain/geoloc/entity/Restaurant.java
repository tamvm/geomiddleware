...
/**
 * Represents a {@link Restaurant}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Restaurant extends GisFeature {
	...
	/**
	 * Constructor that populate the {@link Restaurant} with the gisFeature
	 * fields<br>
	 * 
	 * @param gisFeature
	 ...
	 *            {@link Restaurant}
	 */
	public Restaurant(GisFeature gisFeature) {
		super(gisFeature);
	}
