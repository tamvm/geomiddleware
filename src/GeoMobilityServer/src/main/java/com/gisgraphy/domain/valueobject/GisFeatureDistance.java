...
public class GisFeatureDistance {
	...
	public static class GisFeatureDistanceBuilder {
		...
		public GisFeatureDistanceBuilder withPostalCodeRegex(
		...
		public GisFeatureDistanceBuilder withEquivalentFipsCode(
		...
		public GisFeatureDistanceBuilder withIso3166Alpha2Code(
				String iso3166Alpha2Code) {
			gisFeatureDistance.iso3166Alpha2Code = iso3166Alpha2Code;
			return this;
		}

		public GisFeatureDistanceBuilder withIso3166Alpha3Code(
				String iso3166Alpha3Code) {
			gisFeatureDistance.iso3166Alpha3Code = iso3166Alpha3Code;
			return this;
		}

		public GisFeatureDistanceBuilder withIso3166NumericCode(
		...
		public GisFeatureDistanceBuilder withPostalCodeMask(
	...
	public GisFeatureDistance(GisFeature gisFeature, Double distance) {
		...
		if (gisFeature != null) {
			...
			this.zipCodes = new ArrayList<String>();// TODO tests zip without
			// zipcode
	...
	public void updateFields() {
		...
		if (featureClass != null && featureCode != null) {
			try {
				...
				logger.warn("no feature code for " + featureClass + "_"
						+ featureCode);
			}
		}
	}
	...
	public void addZipCode(String zipCode) {
		...
		this.zipCodes.add(zipCode);// TODO tests zip test this and remove
		// builder.
	}
