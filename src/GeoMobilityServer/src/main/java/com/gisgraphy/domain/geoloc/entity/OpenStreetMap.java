...
/**
 * Represents a street in OpenStreetMap. it is different from {@link Street}
...
public class OpenStreetMap {
	 ...
	 * @see StreetSearchMode#FULLTEXT
	 */
	public static final String FULLTEXTSEARCH_COLUMN_NAME = FULLTEXTSEARCH_PROPERTY_NAME
			.toLowerCase();
	...
	@Column(name = "streettype", nullable = true)
