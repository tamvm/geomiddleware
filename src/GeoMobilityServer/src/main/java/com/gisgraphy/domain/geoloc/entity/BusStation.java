...
/**
 * Represents a {@link BusStation}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class BusStation extends GisFeature {
	...
	/**
	 * Constructor that populate the {@link BusStation} with the gisFeature
	 * fields<br>
	 * 
	 * @param gisFeature
	 ...
	 *            {@link BusStation}
	 */
	public BusStation(GisFeature gisFeature) {
		super(gisFeature);
	}
