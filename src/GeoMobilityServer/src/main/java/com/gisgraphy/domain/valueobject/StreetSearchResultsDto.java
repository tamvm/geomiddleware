...
/**
 * DTO (data transfer object) for a list of {@link StreetDistance} The node name
 * is {@link Constants#STREETSEARCHRESULTSDTO_JAXB_NAME}
 * 
...
public class StreetSearchResultsDto {
	 ...
	 *            The search term
	 */
	public StreetSearchResultsDto(List<StreetDistance> result, Long QTime,
			String query) {
		super();
		this.QTime = QTime;
		this.query = query;
	...
	public List<StreetDistance> getResult() {
		if (result == null)
			result = new ArrayList<StreetDistance>();
		return result;
	}
