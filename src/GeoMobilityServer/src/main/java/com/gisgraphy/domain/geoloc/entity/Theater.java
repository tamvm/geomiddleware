...
/**
 * Represents a {@link Theater}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Theater extends GisFeature {
	...
	/**
	 * Constructor that populate the {@link Theater} with the gisFeature fields<br>
	 * 
	 * @param gisFeature
	 *            The gisFeature from which we want to populate the
	 *            {@link Theater}
	 */
	public Theater(GisFeature gisFeature) {
		super(gisFeature);
	}
