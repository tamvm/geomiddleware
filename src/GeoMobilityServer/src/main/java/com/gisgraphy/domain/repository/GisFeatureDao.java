...
public class GisFeatureDao extends GenericGisDao<GisFeature> implements
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.repository.IGisFeatureDao#listAllFeaturesFromText
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.repository.IGisFeatureDao#getNearestAndDistanceFrom
	 * (com.gisgraphy.domain.geoloc.entity.GisFeature, double, int, int,
	 * java.lang.Class)
	 */
	public List<GisFeatureDistance> getNearestAndDistanceFromGisFeature(
			GisFeature gisFeature, double distance, int firstResult,
			int maxResults, boolean includeDistanceField,
		...
		return getNearestAndDistanceFrom(gisFeature.getLocation(), gisFeature
				.getId(), distance, firstResult, maxResults,
				includeDistanceField, requiredClass, null, true, 0);
	}
	 ...
	 * @see
	 * com.gisgraphy.domain.repository.IGisFeatureDao#getNearestAndDistanceFrom
	 * (com.gisgraphy.domain.geoloc.entity.GisFeature, double, java.lang.Class)
	 */
	public List<GisFeatureDistance> getNearestAndDistanceFromGisFeature(
	 ...
	 * @see
	 * com.gisgraphy.domain.repository.IGisFeatureDao#getNearestAndDistanceFrom
	 * (com.vividsolutions.jts.geom.Point, double, int, int, java.lang.Class)
	 */
	 ...
	 * @see
	 * com.gisgraphy.domain.repository.IGisFeatureDao#getNearestAndDistanceFrom
	 * (com.vividsolutions.jts.geom.Point, double, java.lang.Class)
	 */
	public List<GisFeatureDistance> getNearestAndDistanceFrom(Point point,
			double distance, boolean includeDistanceField,
			Class<? extends GisFeature> requiredClass) {
		return getNearestAndDistanceFrom(point, distance, -1, -1,
				includeDistanceField, requiredClass);
	}
