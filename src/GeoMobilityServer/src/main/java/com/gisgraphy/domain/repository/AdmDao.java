...
public class AdmDao extends GenericGisDao<Adm> implements IAdmDao {
	...
	public List<Adm> getUnused() {
		return (List<Adm>) this.getHT().execute(
				new HibernateCallback() {
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.repository.IAdmDao#getAllbyLevel(java.lang.Integer)
	 */
	@SuppressWarnings("unchecked")
	...
	public long countByLevel(final int level) {
		...
		return ((Long) this.getHT().execute(
				new HibernateCallback() {
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.repository.IAdmDao#getAdmByCountryAndCodeAndLevel
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.repository.IAdmDao#getAdmOrFirstValidParentIfNotFound
	 * (java.lang.String, java.lang.String, java.lang.String, java.lang.String,
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.repository.IAdmDao#suggestMostAccurateAdm(java.lang
	...
	public int deleteAllByLevel(final int level) {
		return ((Integer) this.getHT().execute(
				new HibernateCallback() {
	...
	public List<Long> listFeatureIdByLevel(final int level) {
		return ((List<Long>) this.getHT().execute(
				new HibernateCallback() {
