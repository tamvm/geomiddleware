...
public class ImporterConfig {
	 ...
	 */
	@Required
	public void setOpenstreetmapImporterEnabled(
			boolean openstreetmapImporterEnabled) {
	...
	public void setOpenstreetMapDownloadURL(String openstreetMapDownloadURL) {
		...
		logger.debug("set openstreetMapDownloadURL to "
				+ this.openstreetMapDownloadURL);
	}
	 ...
	 */
	@Required
	public void setOpenStreetMapFilesToDownload(
			String openStreetMapFilesToDownload) {
	...
	public boolean isConfigCorrectForImport() {
		return isRegexpCorrects() && isGeonamesDownloadDirectoryAccessible()
	...
	public String getImporterMetadataDirectoryPath() {
		return getGeonamesDir() + IMPORTER_METADATA_RELATIVE_PATH
				+ File.separator;
	}
	...
	public String createImporterMetadataDirIfItDoesnTExist() {
		if (!isGeonamesDownloadDirectoryAccessible()) {
			if (!new File(getGeonamesDir()).mkdir()) {
				throw new RuntimeException(
						"the geonameDirectory doesn't exists and we can not create it ");
			}
		}
		String dirpath = getGeonamesDir() + IMPORTER_METADATA_RELATIVE_PATH
				+ File.separator;
	 ...
	 */
	@Required
	public void setAlternateNameFeaturesFileName(
			String alternateNameFeaturesFileName) {
	 ...
	 */
	@Required
	public void setAlternateNameCountryFileName(
