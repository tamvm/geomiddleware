...
public enum StreetType {
	...
	BYWAY, MINOR, SECONDARY_LINK, CONSTRUCTION, UNSURFACED, BRIDLEWAY, PRIMARY_LINK, LIVING_STREET, TRUNK_LINK, STEPS, PATH, ROAD, PEDESTRIAN, TRUNK, MOTROWAY, CYCLEWAY, MOTORWAY_LINK, PRIMARY, FOOTWAY, TERTIARY, SECONDARY, TRACK, UNCLASSIFIED, SERVICE, RESIDENTIAL, OTHER;
