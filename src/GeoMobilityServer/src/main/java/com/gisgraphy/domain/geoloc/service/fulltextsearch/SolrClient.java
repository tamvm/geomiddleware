...
public class SolrClient implements IsolrClient {
	...
	@Autowired
	public SolrClient(
			@Qualifier("fulltextSearchUrl") String solrUrl,
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.geoloc.service.fulltextsearch.IsolrClient#bindToUrl
	 * (java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.geoloc.service.fulltextsearch.IsolrClient#getConnection
	 * ()
	 */
	 ...
	 * 
	 * @see
	 * com.gisgraphy.domain.geoloc.service.fulltextsearch.IsolrClient#getURL()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @seecom.gisgraphy.domain.geoloc.service.fulltextsearch.IsolrClient#
	 * setSolRLogLevel(java.util.logging.Level)
	 */
	public void setSolRLogLevel(Level level) {
		...
		Assert.notNull(URL,
				"Solr URL should not be null, can not set log level");
		...
		try {
			try {
				...
				if (responseCode >= 500) {
					throw new RuntimeException("Can not set solr log level to "
							+ level + " because response code is not OK ("
