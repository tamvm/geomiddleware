...
/**
 * Inspect object and all subClass to retrieve the fields in order to be used by
 * the {@link ProjectionBean}
 * 
...
public class IntrospectionHelper {
	 ...
	 * 
	 *         see
	 *         http://java.sun.com/j2se/1.5.0/docs/api/java/lang/reflect/Field
	 *         .html
	 */
