...
public class StatsUsageServiceImpl implements IStatsUsageService {
	...
	public StatsUsageServiceImpl() {
		statsUsageDao = new StatsUsageDao();
		init();
	}
	 ...
	 * 
	 * @see
	 * com.gisgraphy.service.IStatsUsageService#GetUsage(com.gisgraphy.stats
	 * .StatsUsageType)
	 */
	 ...
	 * 
	 * @see
	 * com.gisgraphy.service.IStatsUsageService#increaseUsage(com.gisgraphy.
	 * stats.StatsUsageType)
	 */
