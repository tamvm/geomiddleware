...
public class ProjectionBean extends ProjectionList {
	 ...
	 *            projection are automatically aliased with the same name, you
	 *            could have some problems when using restriction (column yX_
	 *            doesn't exists) see
	 *            http://opensource.atlassian.com/projects/hibernate
	 *            /browse/HHH-817. To avoid this problem you could disable
	 *            aliasing .<br/>
