...
public class IntersectsRestriction implements Criterion {
	...
	public IntersectsRestriction(String columnName, Polygon polygon, boolean isXY) {
		this(columnName, polygon);
		this.isXY = isXY;
	}
	
	public void isNOT(boolean isNOT){
		this.isNOT = isNOT;
	}
	...
	public TypedValue[] getTypedValues(Criteria criteria, CriteriaQuery criteriaQuery) throws HibernateException {
		return new TypedValue[] { criteriaQuery.getTypedValue(criteria, columnName, polygon) };
	}
	...
	public String toSqlString(Criteria criteria, CriteriaQuery criteriaQuery) throws HibernateException {
		...
		if (!isXY)
			columnName = "GeometryFromText(" + columnName + "," + SRID.WGS84_SRID.getSRID() + ")";
		else
			columnName = "GeometryFromText(ST_Transform(" + columnName + ","
					+ SRID.WGS84_SRID.getSRID() + "), " + SRID.WGS84_SRID.getSRID() + ")";

		String result = columnName + " && GeometryFromText( ? ," + SRID.WGS84_SRID.getSRID() + ")";
