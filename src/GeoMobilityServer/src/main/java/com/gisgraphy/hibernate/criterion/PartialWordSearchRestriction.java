 ...
 * =>the DAO store a special string and this criteria search for that string
 * (the searchterms have to be transform too)
 * 
...
public class PartialWordSearchRestriction implements Criterion {
	...
	/**
	 * @param ts_vectorColumnName
	 *            The name of the ts_vector column
	 * @param searchedText
	 *            the text to search
	 */
	public PartialWordSearchRestriction(String ts_vectorColumnName,
			String searchedText) {
		if (ts_vectorColumnName == null) {
			throw new IllegalArgumentException(
					"the name of the ts_vector column can not be null");
		}
		if (searchedText == null) {
			throw new IllegalArgumentException(
					"the search text can not be null");
		}
	...
	public TypedValue[] getTypedValues(Criteria criteria,
		...
		return new TypedValue[] { new TypedValue(Hibernate.STRING, StringHelper
				.transformStringForPartialWordSearch(searchedText,
						StringHelper.WHITESPACE_CHAR_DELIMITER),
				EntityMode.POJO) };
