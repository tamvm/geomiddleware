 ...
 */
public class DistanceRestrictionGreater implements Criterion {
	 ...
	 */
	public DistanceRestrictionGreater(Point point, double distance, boolean useIndex) {
		this.point = point;
	 ...
	 */
	public DistanceRestrictionGreater(Point point, double distance) {
		this.point = point;
		this.distance = distance;
	}
...
//				GeolocHelper.getBoundingBox(criteriaQuery.getSQLAlias(criteria), this.point.getY(),
//				this.point.getX(), distance)).toString() : result.toString();
	}
}
