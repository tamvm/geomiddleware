 ...
 *         &lt;element name="BoundingBox" type="{http://www.opengis.net/gml}BoundingBoxType1"/>
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    protected BoundingBoxType1 boundingBox;
    ...
    public static String service = "WMS";
     ...
     * @return
     *     possible object is
     *     {@link BoundingBoxType1 }
     *     
     */
    public BoundingBoxType1 getBoundingBox() {
        return boundingBox;
    }
     ...
     *     
     */
    public void setBoundingBox(BoundingBoxType1 value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            BoundingBoxType1 theBoundingBox;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetMapType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetMapType that = ((GetMapType) object);
        {
        ...
        {
            BoundingBoxType1 lhsBoundingBox;
            lhsBoundingBox = this.getBoundingBox();
            BoundingBoxType1 rhsBoundingBox;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetMapType) {
            final GetMapType copy = ((GetMapType) draftCopy);
            ...
            if (this.isSetBoundingBox()) {
                BoundingBoxType1 sourceBoundingBox;
                sourceBoundingBox = this.getBoundingBox();
                BoundingBoxType1 copyBoundingBox = ((BoundingBoxType1) strategy.copy(LocatorUtils.property(locator, "boundingBox", sourceBoundingBox), sourceBoundingBox));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GetMapType) {
            final GetMapType target = this;
            final GetMapType leftObject = ((GetMapType) left);
            final GetMapType rightObject = ((GetMapType) right);
            {
                StyledLayerDescriptorElement lhsStyledLayerDescriptor;
            ...
            }
            {
                ...
                target.setBoundingBox(((BoundingBoxType1) strategy.merge(LocatorUtils.property(leftLocator, "boundingBox", lhsBoundingBox), LocatorUtils.property(rightLocator, "boundingBox", rhsBoundingBox), lhsBoundingBox, rhsBoundingBox)));
            }
            {
                OutputType lhsOutput;
